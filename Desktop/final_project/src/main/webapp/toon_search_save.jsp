...
<!DOCTYPE html>
    ...
    request.setCharacterEncoding("utf-8");	
 	String search = request.getParameter("box");
    ...
    String sql = "SELECT * FROM webtoon_list WHERE title='"+ search +"'OR writer='"+search + "'";
...
<div class="header">
<form action="toon_search_save.jsp">
<span class="logo">
<img src="작은로고.png" id="logoimage" onclick="location.href='main.jsp'" style="width:220px; height:55px;">
</span>
<span class="search">
<button type="submit" id="search" ><img src="search.icon.png"   id="search.icon" style="width:20px; height:20px;"></button>
<span id="searchbox"><input type="text" name="search" id="box" value="웹툰명/작가명을 검색하세요."></span>
</span>
<span class="buttons">
